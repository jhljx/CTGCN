...
from structure_generation import StructuralNetworkGenerator
from tensor_generation import TensorGenerator
...
if __name__ == '__main__':
    preprocessing = Preprocessing(base_path="..\\data\\email-eu", input_folder="1.format",
                                  output_folder="RWT-GCN", node_file="nodes_set\\nodes.csv",
                                  hop=1, ratio=1, max_cnt=10, min_sim=0.5,
                                  walk_time=100, walk_length=10, p=0.5)
    preprocessing.run(worker=2)